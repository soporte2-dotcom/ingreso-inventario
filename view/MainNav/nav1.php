...
$usuariosConAccesoUtilidades = ['BREN', 'YEISONT', 'JVELEZ', 'ELIMAR', 'JPOLANCO', 'SJARAMI', 'LACRUZ', 'CAMPLAZA', 'ESTAGON'];

$usuariosConAccesoEntradas = ['NPADILLA', 'MILADYS', 'KARINA', 'JCABAL', 'JNARVAEZ', 'SERNEL', 'WORDUZ', 'JVELASCO', 
'LSALAS', 'JNARVAEZ', 'DANYO', 'YOLANDAT', 'ESIERRA', 'LGARCIA', 'JALVAREZ', 'MICHAELK','AMEJIA','JRIVAS', 'LCASTILL', 'JMENDOZA', 'VGARZON', 'DAYANALE',
'ABOLIVAR', 'YDIAZ', 'MBOTINA', 'JALVAREZ', 'ESTAGON'];
