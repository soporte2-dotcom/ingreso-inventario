...
<body class="with-side-menu sidebar-hidden">
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="box-typical box-typical-padding">
                ...
                <div class="row mb-3">
                    <div class="col-sm-6">
                        <button type="button" class="btn btn-success btn-rounded" onclick="abrirModalCrear()">
                            <i class="fa fa-plus"></i> Nueva Etapa
                        </button>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <table id="tbEtapas" class="table table-bordered table-striped table-vcenter js-dataTable-full">
                            <thead>
                                <tr>
    ...
    <div class="modal fade" id="modalEtapa" tabindex="-1" role="dialog"
         aria-labelledby="modalEtapaTitle" aria-hidden="true"
         data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalEtapaTitle">Nueva Etapa</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="etapaNombre" class="form-control"
                               placeholder="Ingrese el nombre de la etapa" maxlength="50" autocomplete="off">
                        <small class="form-text text-muted">Máximo 50 caracteres.</small>
                    </div>

                    <div class="form-group" id="divEstado" style="display:none">
                        <label class="font-weight-bold">Estado</label>
                        <select id="etapaEstado" class="form-control">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="btnGuardarEtapa" class="btn btn-success" onclick="guardarEtapa()">
    ...
    <script src="etapas.js?v=1"></script>
