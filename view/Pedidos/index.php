...
<body class="with-side-menu sidebar-hidden">
	...
	<div class="page-content">
		<div class="container-fluid">
				...
				<div class="tbl">
					<div class="tbl-row">
						...
						<div class="tbl-cell tbl-cell-action">
							<a href="../ConsultarPedidos/" class="btn btn-secondary btn-md">
			...
			<div class="box-typical box-typical-padding">
				...
				<div id="avisoConsulta" class="alert alert-info" style="display:none">
					<i class="fa fa-lock"></i> Este documento ya fue guardado y está en modo consulta. No se pueden hacer cambios.
				</div>
				...
				<div class="row">
					<div class="col-sm-6 col-md-3 col-lg-2 d-flex mx-auto">
						<button type="button" name="action"  class="modalagregar d-flex w-15 btn btn-rounded btn-inline btn-.bg-primary" data-toggle="modal" data-target="#modalagregar" style="display: none" id="agregar">Agregar Registros</button>
					</div>
					<div class="col-sm-6 col-md-3 col-lg-2 d-flex mx-auto">
								...
								<div class="modal-dialog modal-lg" role="document">
									<div class="modal-content">
										...
										<div class="modal-footer">
											...
											<button type="button" id="btnCargarExcel" class="btn btn-success" onclick="procesarBotonExcel()">
	...
	<!-- Contenido -->
	<script type="text/javascript" src="pedidos.js?v=<?php echo time(); ?>"></script>
